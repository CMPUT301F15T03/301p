...
public class HttpClientAsync {
    ...
    public HttpClientAsync(String root) throws MalformedURLException {
        this(new URL(root));
    }

    public HttpClientAsync(URL root) {
        this.root = root;
    }
    ...
    protected HttpResponse makeDataLessRequest(String suffix, HttpMethods method) throws IOException {
    ...
    protected HttpResponse makeSendDataRequest(String suffix, byte[] dataToBeSent, HttpMethods sendMethod) throws IOException {
